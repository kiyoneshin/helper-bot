"""
_staff_log.py — Module Helper Tập Trung Nhật Ký Nhân Sự (Staff Audit Log)
==========================================================================
Cung cấp:
  - Hàm `send_staff_log(bot, embed)` để gửi Embed vào kênh log ẩn.
  - Các hàm build_embed_* tiện ích để tạo nhanh các Embed chuẩn hóa
    cho từng loại sự kiện.
"""

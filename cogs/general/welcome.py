    ...
    async def on_member_join(self, member: discord.Member):
        ...
        if isinstance(channel, discord.TextChannel):
            try:
                ...
                # troll_message = f"#  Một cộng đồng lành mạnh, văn minh và thân thiện. Nói không với toxic, chửi bới hay công kích cá nhân. Tại đây mọi người đều được tôn trọng, thoải mái trò chuyện, kết bạn và cùng nhau tạo nên một không gian tích cực. Chào mừng bạn đến với server! ️️️‍<:gift_00_symbol:1536003307011842099>️‍️‍️"

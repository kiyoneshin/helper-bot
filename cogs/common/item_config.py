...
ITEM_REGISTRY: dict[int, ItemEntry] = {
    ...
    70: {
        ...
        "icon":        "🥗",
        "price":       None,
        "description": "Món ăn thanh đạm. Hồi ngay 30 Thể Lực. (Tối đa về mức Full).",
        "db_key":      "food_70",
        "category":    "food",
        "usable":      True,
    },
    71: {
        ...
        "icon":        "🎃",
        "price":       None,
        "description": "Món súp ấm áp. Tăng 100% tốc độ hồi thể lực trong 2 giờ.",
        "db_key":      "food_71",
        "category":    "food",
        "usable":      True,
    },
    72: {
        ...
        "icon":        "🍱",
        "price":       None,
        "description": "Cơm cuộn truyền thống. Tăng 20% tỉ lệ rơi Lootbox trong 1 giờ.",
        "db_key":      "food_72",
        "category":    "food",
        "usable":      True,
    },
    73: {
        ...
        "icon":        "🍹",
        "price":       None,
        "description": "Giải khát tuyệt đỉnh. Tăng 15% tỉ lệ rơi Lootbox hiếm (Rare/Epic) trong 1 giờ.",
        "db_key":      "food_73",
        "category":    "food",
        "usable":      True,
    },
    74: {
        ...
        "icon":        "🥔",
        "price":       None,
        "description": "Món ăn no bụng. Tăng thêm 1 sản lượng khi thu hoạch nông trại trong 4 giờ.",
        "db_key":      "food_74",
        "category":    "food",
        "usable":      True,
    },
    75: {
        ...
        "icon":        "🍢",
        "price":       None,
        "description": "Thơm lừng mùi củi. Tăng 30% tỉ lệ rơi Gỗ hiếm (Woodcutting) trong 1 giờ.",
        "db_key":      "food_75",
        "category":    "food",
        "usable":      True,
    },
    76: {
        ...
        "icon":        "🍝",
        "price":       None,
        "description": "Nạp năng lượng thợ mỏ. Tăng 30% tỉ lệ rơi Quặng hiếm (Mining) trong 1 giờ.",
        "db_key":      "food_76",
        "category":    "food",
        "usable":      True,
    },
    77: {
        ...
        "icon":        "🥧",
        "price":       None,
        "description": "Mồi câu hảo hạng. Tăng 15% tỉ lệ câu được Cá hiếm (Fishing) trong 1 giờ.",
        "db_key":      "food_77",
        "category":    "food",
        "usable":      True,
    },
    78: {
        ...
        "icon":        "🍵",
        "price":       None,
        "description": "Thanh lọc cơ thể. Giảm 1 Thể Lực tiêu hao cho mọi hành động trong 1 giờ.",
        "db_key":      "food_78",
        "category":    "food",
        "usable":      True,
    },
    79: {
        ...
        "icon":        "🍲",
        "price":       None,
        "description": "Tinh hoa hội tụ. Tăng TOÀN BỘ tỉ lệ rơi Lootbox và Đồ hiếm lên 35% trong 2 giờ.",
        "db_key":      "food_79",
        "category":    "food",
        "usable":      True,
    }

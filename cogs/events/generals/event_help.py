...
CMD_DATA: dict[str, dict] = {
    ...
    "wheel": {
        "name": "Vòng Quay",
        "emoji": "🎡",
        "short": "Vòng quay 16 ô. Ô Tím x9.0, Xanh lá x1.8. Có ô Vàng đặc biệt.",
        "aliases": [],
        "cooldown": None,
    ...
    "taixiu": {
        ...
        "note": "Bão (3 viên giống nhau): Mất sạch.",
    },
    "baucua": {
        "name": "Bầu Cua",
        "emoji": "🦀",
    ...
    "xoso": {
        ...
        "aliases": ["lottery", "xs"],
        "cooldown": None,
        "usage": "y!xoso <mua|ban|xem> [số_lượng|id_vé]",
        "examples": ["y!xoso mua 5", "y!xoso ban 12"],
        "note": "Kết quả xổ lúc cuối ngày. `y!xoso mua` để mua vé, `y!xoso ban` để bán lại.",
    },
    "multidice": {
        "name": "Multi Dice (PvP)",
        "emoji": "🎲",
    ...
    "black_market": {
        ...
        "aliases": ["choden", "chodem", "blackmarket", "bm"],
        "cooldown": None,
        "usage": "y!choden",
        "examples": ["y!choden"],
    ...
    "marry": {
        ...
        "note": "Nếu không tag ai sẽ hiển thị Profile Tình Yêu. Nhẫn ID 31-34 mua trong y!shop.",
    },
    "divorce": {
        "name": "Ly Hôn",
        "emoji": "💔",

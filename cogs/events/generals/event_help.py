...
CMD_DATA: dict[str, dict] = {
    ...
    "dice": {
        "name": "Dice 7",
        "emoji": "<:gambling_dice:1537539887769591828>",
    ...
    "daily": {
        "name": "Điểm Danh",
        "emoji": "<:gift_00_symbol:1536003307011842099>",
        "short": "Nhận thưởng 500 <:symbol_points_p:1538282388507987989> mỗi ngày. Chuỗi càng dài, thưởng càng lớn.",
        "aliases": ["diemdanh"],
        "cooldown": "24h",
        "usage": "{prefix}daily",
        "examples": ["{prefix}daily"],
        "note": "Thưởng chuỗi (streak) cộng thêm tối đa 500 <:symbol_points_p:1538282388507987989>/ngày.",
    },
    "weekly": {
        "name": "Lương Tuần",
        "emoji": "💎",
        "short": "Nhận lương 5,000 <:symbol_points_p:1538282388507987989> mỗi tuần (7 ngày/lần).",
        "aliases": ["luongtuan"],
        "cooldown": "7 ngày",
        "usage": "{prefix}weekly",
    ...
    "cook": {
        ...
        "aliases": ["nauan"],
        "cooldown": None,
        "usage": "{prefix}cook <id> [số_lượng]",
        "examples": ["{prefix}cook 70", "{prefix}cook 71 5"],
        "note": "Kiểm tra ID và công thức trong bảng `krecipe`.",
    },
    "boost": {
        "name": "Hiệu Ứng",
        "emoji": "<a:symbol_star_yellow:1537739289834553385>",
        ...
        "cooldown": None,
        "usage": "{prefix}boost",
        "examples": ["{prefix}boost"],
        "note": "Hiệu ứng có được từ đồ ăn hoặc P2W.",
    },
    "task": {
...
class HomeView(discord.ui.View):
    ...
    async def interaction_check(self, interaction: discord.Interaction) -> bool:
        if interaction.user.id != self.author.id:
            await interaction.response.send_message("<:symbol_ban:1537546960003801319> Đây không phải cẩm nang của bạn!", ephemeral=True)
            return False
        return True

...
PROFESSIONS: dict[str, dict] = {
    ...
    "gatherer": {
        ...
        "icon": "🎒",
        "description": "Giảm 1 Thể Lực tiêu hao mỗi lần chặt cây (tối thiểu 1).",
    ...
    "trapper": {
        ...
        "name": "Bẫy Thủ",
        "icon": "🕸️",
        "description": "Tăng cửa sổ Perfect Catch lên 3.5s (mặc định 2s), dễ đạt Perfect hơn.",
    ...
    "pirate": {
        ...
        "name": "Cướp Biển",
        "icon": "🏴‍☠️",
        "description": "Nhân đôi tỉ lệ rơi Cá Hiếm (Rare rank 3+ được tăng x2).",
    ...
    "mariner": {
        ...
        "name": "Thủy Thủ",
        "icon": "⚓",
        "description": "Không bao giờ câu được Rác (trash). Tỉ lệ rác chuyển sang cá Common.",

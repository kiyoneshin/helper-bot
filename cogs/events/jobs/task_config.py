...
WEEKLY_TASKS = {
    ...
    "w5": {"name": "Bám rễ phòng voice", "desc": "Ngồi voice chat 60 chu kỳ (1 tiếng).", "action": "voice", "target": 60, "reward_min": 1500, "reward_max": 2500},
    "w6": {"name": "Nhà sưu tầm Giveaway", "desc": "Tham gia 15 cái Giveaway.", "action": "giveaway_join", "target": 15, "reward_min": 1500, "reward_max": 2500},
    "w7": {"name": "Khách ruột ngân hàng", "desc": "Thực hiện vay hoặc trả nợ ngân hàng 3 lần.", "action": "bank_tx", "target": 3, "reward_min": 1500, "reward_max": 2500},
}
...
# ==========================================
QUESTS = {
    "q1": {"name": "🌟 Đế Vương May Mắn", "desc": "Chiến thắng 5 lần Giveaway.", "action": "giveaway_win", "target": 5, "reward_fixed": 5000},

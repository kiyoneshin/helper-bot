...
async def start_mvp_tribute_game(bot, channel: discord.abc.Messageable, core_cog):
    ...
    embed = discord.Embed(
        ...
        description=(
            ...
            f"• Ai gõ đúng và nhanh sẽ được cộng ngay **+50 <:symbol_points_p:1538282388507987989>** sự kiện!\n"
            f"• **Đặc quyền:** Không cần gõ, ngồi mát ăn bát vàng! Nhận ngay 10% hoa hồng (+5 <:symbol_points_p:1538282388507987989>) từ mỗi câu chúc của mọi người! 🌸"
        ),
        color=0xff80df
    )
    ...
    embed.description = (
        ...
        f"**MVP:** Nhận được **+{total_commission} <:symbol_points_p:1538282388507987989>** hoa hồng từ {len(congratulators)} lời chúc!"
    )
